/**
 * Tests for expanded LegroomClient — chat.completions, messages, metrics, CCR, etc.
...
describe("LegroomClient constructor", () => {
...
describe("LegroomClient.health()", () => {
  ...
  it("returns health status", async () => {
    ...
    const client = new LegroomClient({ baseUrl: "http://test:8787" });
...
describe("LegroomClient.proxyStats()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient.getMetrics()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient.getSummary()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient.validateSetup()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient.retrieve()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient.clearCache()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient.compressRaw()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("LegroomClient config passthrough", () => {
  beforeEach(() => vi.clearAllMocks());
