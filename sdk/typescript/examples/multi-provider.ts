 ...
 *
 * Use the same withLegroom wrapper across different providers.
 * Legroom compresses identically regardless of which LLM you use.
 *
...
async function main() {
  ...
  const gpt = withLegroom(openai("gpt-4o"));
  ...
  const mini = withLegroom(openai("gpt-4o-mini"));
