"""Canonical MCP publication metadata for the Legroom server."""
...
from .install import build_legroom_spec

SCHEMA_URL = "https://static.modelcontextprotocol.io/schemas/2025-12-11/server.schema.json"
SERVER_NAME = "io.github.legroom-ai/legroom"
SERVER_TITLE = "Legroom"
SERVER_DESCRIPTION = (
    "Legroom MCP server for compression, retrieval, and stats in MCP-compatible hosts."
)
PYPI_OWNERSHIP_MARKER = f"<!-- mcp-name: {SERVER_NAME} -->"
WEBSITE_URL = "https://legroom-ai.github.io/legroom/"
REPOSITORY_URL = "https://github.com/legroom-ai/legroom"
...
def _build_mcp_package_spec(metadata: ProjectMetadata) -> str:
    """Return the PyPI requirement needed to launch ``legroom mcp serve``."""

    return f"{metadata.package_name}[mcp]"


def build_server_json(metadata: ProjectMetadata | None = None) -> dict[str, object]:
    """Build the canonical ``server.json`` payload for Legroom."""
