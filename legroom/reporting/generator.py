"""HTML report generator for Legroom SDK."""
...
def _get_jinja2_template(template_str: str):
    ...
    try:
        ...
        raise ImportError(
            "jinja2 is required for report generation. Install with: pip install legroom[reports]"
        ) from e
...
<head>
    ...
    <title>Legroom Report - {{ generated_at }}</title>
    <style>
        * {
...
<body>
    <div class="container">
        <header>
            <h1>Legroom Context Analysis Report</h1>
        ...
        <footer>
            Generated by Legroom SDK v0.1.0
        </footer>
    </div>
</body>
</html>
