...
Instead, please email us at: **security@legroom.ai**
...
- Legroom Python package (`pip install legroom-ai`)
...
Legroom includes several security features:
...
Thank you for helping keep Legroom and its users safe!
