...
//! [`legroom_core::transforms::LiveZoneOutcome`] and the
...
//!    [`legroom_core::transforms::compress_anthropic_live_zone`].
...
//! `crates/legroom-core/tests/live_zone_dispatch.rs` pins the
