...
See [issue #746](https://github.com/ghaliba3/headroom/issues/746) for the full analysis.
...
4. File an issue at [github.com/ghaliba3/headroom](https://github.com/ghaliba3/headroom/issues) with your Headroom version, Python version, provider, debug log output, and minimal reproduction code
