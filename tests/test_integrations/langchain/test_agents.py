...
3. LegroomToolWrapper - Wrapper for LangChain tools with compression
...
class TestToolCompressionMetrics:
    ...
    def test_create_metrics(self):
        ...
        from legroom.integrations.langchain.agents import ToolCompressionMetrics
...
class TestToolMetricsCollector:
    ...
    def test_init_empty(self):
        ...
        from legroom.integrations.langchain.agents import ToolMetricsCollector
...
class TestLegroomToolWrapper:
    ...
    def test_call_large_output_triggers_compression(self, mock_tool_with_large_output):
        ...
        with patch("legroom.integrations.langchain.agents.compress_tool_result") as mock_compress:
...
class TestWrapToolsWithLegroom:
    ...
    def test_wrap_multiple_tools(self, mock_tool):
        ...
        wrapped = wrap_tools_with_legroom([mock_tool, tool2])
    ...
    def test_wrap_with_custom_threshold(self, mock_tool):
        ...
        wrapped = wrap_tools_with_legroom([mock_tool], min_chars_to_compress=500)
...
class TestGlobalMetrics:
    ...
    def test_wrapper_uses_global_metrics_by_default(self, mock_tool):
        """LegroomToolWrapper uses global metrics by default."""
        from legroom.integrations.langchain.agents import (
            LegroomToolWrapper,
            get_tool_metrics,
            reset_tool_metrics,
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from legroom.integrations.langchain.agents import _check_langchain_available
