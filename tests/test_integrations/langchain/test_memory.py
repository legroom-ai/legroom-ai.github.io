...
Tests cover:
1. LegroomChatMessageHistory - Wrapper for chat message history with compression
...
class TestLegroomChatMessageHistoryInit:
    """Tests for LegroomChatMessageHistory initialization."""
    ...
    def test_init_defaults(self, mock_base_history):
        ...
        with patch("legroom.integrations.langchain.memory.OpenAIProvider"):
            history = LegroomChatMessageHistory(mock_base_history)
...
class TestLegroomChatMessageHistoryMessages:
    ...
    def test_messages_returns_empty_when_no_messages(self, mock_base_history, mock_provider):
        ...
        history = LegroomChatMessageHistory(mock_base_history, provider=mock_provider)
...
class TestLegroomChatMessageHistoryAddMessage:
...
class TestLegroomChatMessageHistoryConversion:
...
class TestLegroomChatMessageHistoryTokenCounting:
...
class TestLegroomChatMessageHistoryStats:
...
class TestLegroomChatMessageHistoryCompression:
    ...
    def test_apply_compression_calls_pipeline(self, mock_base_history, mock_provider):
        ...
        with patch("legroom.integrations.langchain.memory.TransformPipeline") as MockPipeline:
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from legroom.integrations.langchain.memory import _check_langchain_available
